...
<details>
  ...
  - Data de entrega para avaliação regular do projeto: `03/02/2023 14:00`.
...
1. Clone o repositório
  * `git clone git@github.com:tryber/sd-025-a-mysql-one-for-all.git`.
  * Entre na pasta do repositório que você acabou de clonar:
    * `cd sd-025-a-mysql-one-for-all`
